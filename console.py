#!/usr/bin/env python3
"""
This module provides a command-line interface for managing objects in the HBnB clone.
"""
...
"""
A command-line interpreter for managing objects in an HBNB data storage system.
"""
...
"""
Exit the command interpreter when the end-of-file (EOF) is reached.
"""
print()
return True
...
"""
print("\nUsage: EOF\n")
print("This command allows you to gracefully exit the command interpreter by pressing Ctrl+D (EOF).\n")
...
"""
print("\nUsage: quit\n")
print("This command allows you to gracefully exit the command interpreter.\n")
...
Returns:
int, float, or str: The converted value if the input matches the format of an integer or a float;
...
print("This command creates a new instance of the specified class and assigns it a unique identifier.\n")
...
print("Destroy command deletes an instance by class name and instance ID.\n")
def do_all(self, line=None):
"""
Display string representations of all instances.

Args:
line (str, optional): The user input containing an optional class name for filtering instances.
"""
instances = storage.all()
line_arr = shlex.split(line)
...
"""
print("\nUsage: help all\n")
print("The all command displays string representations of all instances.")
print("Optionally, provide a class name to filter instances of a specific class.\n")
...
Args:
line (str or list): The user input containing class name, ID, attribute name, and new attribute value.
...
"""
print("\nUsage: help update\n")
print("The update command modifies an instance's attribute value by class name, instance ID, attribute name, and value.")
print("Provide required arguments to perform the update.\n")

def default(self, line):
"""
Handle behavior for commands of the format <cls>.<cmd>(<additional_args>).
